"""
Generate two interactive maps of Rajasthan.
...
Outputs: rajasthan_district_potential_map.html, rajasthan_distributor_territory_map.html
"""
...
GEOJSON_PATH = os.path.join(BASE_DIR, "rajasthan_districts.geojson")
MAP1_PATH    = os.path.join(BASE_DIR, "rajasthan_district_potential_map.html")
MAP2_PATH    = os.path.join(BASE_DIR, "rajasthan_distributor_territory_map.html")

# --- State Identity ---------------------------------------------------------
STATE_NAME  = "RAJASTHAN"   # Must match Excel col[1] exactly
STATE_LABEL = "Rajasthan"   # Display name for titles/legends

# --- State Bounding Box (with ~0.15 deg padding) ---------------------------
STATE_BOUNDS = [[23.06, 69.48], [30.19, 78.27]]
STATE_CENTER  = [26.50, 73.80]
...
DISTRIBUTOR_COLORS = {
    "J P ALLOYS":                      "#e41a1c",
    "M R ASSOCIATES":                  "#377eb8",
    "Swastik Tradevision Pvt. Ltd.":   "#4daf4a",
    "BD ISPAT AND ALLOYS":             "#ff7f00",
}

DISTRIBUTOR_SHORT = {
    "J P ALLOYS":                      "JP Alloys",
    "M R ASSOCIATES":                  "MR Associates",
    "Swastik Tradevision Pvt. Ltd.":   "Swastik Tradevision",
    "BD ISPAT AND ALLOYS":             "BD Ispat & Alloys",
}
