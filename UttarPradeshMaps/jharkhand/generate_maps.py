"""
Generate two interactive maps of Jharkhand.
...
Outputs: jharkhand_district_potential_map.html, jharkhand_distributor_territory_map.html
"""
...
GEOJSON_URL  = "https://raw.githubusercontent.com/datta07/INDIAN-SHAPEFILES/master/STATES/JHARKHAND/JHARKHAND_DISTRICTS.geojson"
GEOJSON_PATH = os.path.join(BASE_DIR, "jharkhand_districts.geojson")
MAP1_PATH    = os.path.join(BASE_DIR, "jharkhand_district_potential_map.html")
MAP2_PATH    = os.path.join(BASE_DIR, "jharkhand_distributor_territory_map.html")
...
STATE_BOUNDS = [[21.82, 83.18], [25.50, 88.11]]
STATE_CENTER  = [23.66, 85.65]
...
DISTRIBUTOR_COLORS = {
    "M/S REAL DREAMS ENTERPRISES":  "#e41a1c",
    "M/S TIRUPATI SALES":           "#377eb8",
    "Lalsar Steel":                  "#4daf4a",
    "Amco Associates":               "#ff7f00",
}

DISTRIBUTOR_SHORT = {
    "M/S REAL DREAMS ENTERPRISES":  "Real Dreams",
    "M/S TIRUPATI SALES":           "Tirupati Sales",
    "Lalsar Steel":                  "Lalsar Steel",
    "Amco Associates":               "Amco Associates",
}
