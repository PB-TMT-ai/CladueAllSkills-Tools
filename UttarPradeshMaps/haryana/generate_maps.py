"""
Generate two interactive maps of Haryana.
...
Outputs: haryana_district_potential_map.html, haryana_distributor_territory_map.html
"""
...
GEOJSON_URL  = "https://raw.githubusercontent.com/datta07/INDIAN-SHAPEFILES/master/STATES/HARYANA/HARYANA_DISTRICTS.geojson"
GEOJSON_PATH = os.path.join(BASE_DIR, "haryana_districts.geojson")
MAP1_PATH    = os.path.join(BASE_DIR, "haryana_district_potential_map.html")
MAP2_PATH    = os.path.join(BASE_DIR, "haryana_distributor_territory_map.html")

# --- State Identity ---------------------------------------------------------
STATE_NAME  = "HARYANA"   # Must match Excel col[1] exactly
STATE_LABEL = "Haryana"   # Display name for titles/legends

# --- State Bounding Box (with ~0.15 deg padding) ---------------------------
STATE_BOUNDS = [[27.50, 74.32], [31.08, 77.75]]
STATE_CENTER  = [29.29, 76.04]

# --- Name mapping: Excel -> GeoJSON ----------------------------------------
EXCEL_TO_GEOJSON = {}   # Haryana: perfect match, no normalization needed

# Reverse mapping (auto-built)
...
DISTRIBUTOR_COLORS = {
    "NIKUNJ UDYOG":                    "#e41a1c",
    "PAL CEMENT AND STEEL PVT. LTD.":  "#377eb8",
    "RAMDOOT UDHYOG PRIVATE LIMITED":  "#4daf4a",
    "JAI DURGA STEELS":                "#ff7f00",
}

DISTRIBUTOR_SHORT = {
    "NIKUNJ UDYOG":                    "Nikunj Udyog",
    "PAL CEMENT AND STEEL PVT. LTD.":  "Pal Cement & Steel",
    "RAMDOOT UDHYOG PRIVATE LIMITED":  "Ramdoot Udhyog",
    "JAI DURGA STEELS":                "Jai Durga Steels",
}
...
def main():
    ...
    geojson_data = load_geojson()  # Reload (Map 1 modifies _popup properties)
