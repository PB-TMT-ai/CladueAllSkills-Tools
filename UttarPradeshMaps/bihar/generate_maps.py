"""
Generate two interactive maps of Bihar.
...
Outputs: bihar_district_potential_map.html, bihar_distributor_territory_map.html

Notes:
  - Patna has two Excel rows (KHARAKIA METALS: Very High, MEWARAM: Medium).
    First row wins for potential; both distributors appear in popups/territory map.
  - Araria is in GeoJSON but not in Excel — renders grey (no data). This is expected.
"""
...
GEOJSON_URL  = "https://raw.githubusercontent.com/datta07/INDIAN-SHAPEFILES/master/STATES/BIHAR/BIHAR_DISTRICTS.geojson"
GEOJSON_PATH = os.path.join(BASE_DIR, "bihar_districts.geojson")
MAP1_PATH    = os.path.join(BASE_DIR, "bihar_district_potential_map.html")
MAP2_PATH    = os.path.join(BASE_DIR, "bihar_distributor_territory_map.html")
...
STATE_BOUNDS = [[24.14, 83.17], [27.67, 88.45]]
STATE_CENTER  = [25.90, 85.81]
...
DISTRIBUTOR_COLORS = {
    "KHARAKIA METALS PRIVATE LIMITED":   "#e41a1c",
    "MEWARAM MADHUSUDAN PRASAD & SONS":  "#377eb8",
    "SUBH NEXTGEN PRIVATE LIMITED":      "#4daf4a",
}

DISTRIBUTOR_SHORT = {
    "KHARAKIA METALS PRIVATE LIMITED":   "Kharakia Metals",
    "MEWARAM MADHUSUDAN PRASAD & SONS":  "Mewaram & Sons",
    "SUBH NEXTGEN PRIVATE LIMITED":      "Subh Nextgen",
}
