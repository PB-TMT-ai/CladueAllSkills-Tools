"""
generate_consolidated_map_v2.py
V2 consolidated India map — choropleth + factory-icon plant markers + compact legend.
...
- No state-wise breakdown table
- Map maximized to fill most of the image
"""
...
OUTPUT_FILE = os.path.join(OUTPUT_DIR, "consolidated_supply_map_v2.png")
...
def generate_consolidated_map_v2():
    """Generate V2 of the consolidated supply map."""
    ...
    plt.savefig(OUTPUT_FILE, dpi=300, bbox_inches='tight', facecolor='white',
                pad_inches=0.3)
    plt.close()
    print(f"V2 map saved: {OUTPUT_FILE}")


if __name__ == "__main__":
    generate_consolidated_map_v2()
