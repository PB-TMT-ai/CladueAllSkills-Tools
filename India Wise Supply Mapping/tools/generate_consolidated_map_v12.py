"""
generate_consolidated_map_v12.py
V12 consolidated map — 50% larger labels, 50% smaller icons.
...
OUTPUT_FILE = os.path.join(OUTPUT_DIR, "consolidated_supply_map_v12.png")
...
def generate():
    ...
    for i, pname in enumerate(plant_order, 1):
        ...
        # V12: zoom=0.5 (halved from V11's 1.0)
    ...
    plt.savefig(OUTPUT_FILE, dpi=300, bbox_inches='tight', facecolor='white',
                pad_inches=0.3)
    plt.close()
    print(f"V12 map saved: {OUTPUT_FILE}")
